...
description: How to use the SAP Cloud SDK for AI for Java to perform embedding tasks using OpenAI models deployed on SAP AI Core.
keywords:
  - sap
  - cloud
  - sdk
...
This guide demonstrates how to use the SAP Cloud SDK for AI for Java to perform embedding tasks using OpenAI models deployed on SAP AI Core.
...
We're excited to introduce a new user interface for OpenAI embedding calls starting with **version 1.4.0**. This update is designed to improve the SAP Cloud SDK for AI by:
