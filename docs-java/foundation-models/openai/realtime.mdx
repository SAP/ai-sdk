...
See the [Spring Boot sample application](https://github.com/SAP/ai-sdk-java/tree/main/sample-code/spring-app) for a complete example that bridges a browser WebSocket connection to the OpenAI Realtime API.
