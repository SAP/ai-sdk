...
The SAP Cloud SDK for AI uses the [`Destination` concept of the SAP Cloud SDK](https://sap.github.io/cloud-sdk/docs/java/features/connectivity/destination-service) to connect to AI Core.
...
The SAP Cloud SDK for AI will automatically detect the service binding and use it to connect to AI Core.
