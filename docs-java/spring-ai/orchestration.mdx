...
As of version `1.25.0` the minimum required version for Spring AI is `2.0.1`.
Please refer to the [official Spring AI upgrade guide](https://docs.spring.io/spring-ai/reference/upgrade-notes.html#upgrading-to-2-0-1) for details on how to upgrade from a previous milestone version.
:::
...
OrchestrationModuleConfig config = new OrchestrationModuleConfig(GPT_4O_MINI);
