...
MCP servers can be used together with the AI SDK seamlessly through to the existing [integration with Spring AI](https://docs.spring.io/spring-ai/reference/api/mcp/mcp-client-boot-starter-docs.html).
...
Once you've configured the MCP client, you can autowire the tools into your class:
