...
For detailed information on the behaviour of input and output filters, check the [Filter Documentation for Orchestration](https://sap.github.io/ai-sdk/docs/java/orchestration/chat-completion#filtering).
