...
for chat completion tasks using the SAP Cloud SDK for AI for Java.
...
The SAP Cloud SDK for AI currently uses the [M6 milestone](https://spring.io/blog/2025/02/14/spring-ai-1-0-0-m6-released).

Please be aware that future versions of the SAP Cloud SDK for AI may increase the Spring AI version.
:::
