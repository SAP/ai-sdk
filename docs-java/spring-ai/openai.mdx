...
description: How to use our Spring AI integration with our OpenAI client in SAP AI Core for chat completion tasks using the SAP Cloud SDK for AI for Java.
keywords:
  - sap
  - cloud
  - sdk
