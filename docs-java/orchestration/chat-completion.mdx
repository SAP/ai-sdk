...
In order to then use the sharepoint for grounding in your code, you can simply add its corresponding data repository ID to the `DocumentGroundingFilter` object.
