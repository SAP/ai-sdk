...
description: How to use the Orchestration service in SAP AI Core for chat completion tasks using the SAP Cloud SDK for AI for Java.
keywords:
  - sap
  - cloud
  - sdk
...
This guide provides examples of how to use the [Orchestration service in SAP AI Core](https://help.sap.com/docs/sap-ai-core/sap-ai-core-service-guide/orchestration) for chat completion tasks using the SAP Cloud SDK for AI for Java.
...
var userMessage = Message.user("""
                 I think the SAP Cloud SDK for AI is good, but could use some further enhancements.
