...
var configs = new OrchestrationModuleConfig[] {brokenConfig, workingConfig};

OrchestrationChatResponse result = client.chatCompletion(prompt, configs);
// or:
// OrchestrationChatResponse result = client.chatCompletion(prompt, brokenConfig, workingConfig);
```
