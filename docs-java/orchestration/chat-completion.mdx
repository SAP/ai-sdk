...
The following sample will translate the prompt in English, send it to the LLM, and then translate the output to German.
...
You can also optionally specify the source language, **the source-target pair has to be in the [list](https://github.com/SAP/ai-sdk-java/tree/main/sample-code/spring-app/src/main/java/com/sap/ai/sdk/app/services/OrchestrationService.java).**
