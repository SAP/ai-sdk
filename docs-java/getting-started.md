...
For more information on how to set up an AI Core service instance, and which service plan to choose, please refer to [this documentation](https://help.sap.com/docs/sap-ai-core/sap-ai-core-service-guide/service-plans).

Furthermore, it assumes you are using the `default` resource group.
If you want or need to use a different resource group, please refer to [this guide](orchestration/chat-completion#create-a-client-and-choose-an-llm), please ensure that resource group has an [orchestration deployment](https://help.sap.com/docs/sap-ai-core/sap-ai-core-service-guide/create-deployment-for-orchestration).
...
Please find **detailed instructions** and more examples [in this documentation](connecting-to-ai-core#using-the-aicore_service_key-environment-variable).
...
Please refer to [this documentation](orchestration/chat-completion) for more information.
