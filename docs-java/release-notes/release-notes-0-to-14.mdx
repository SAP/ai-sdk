...
- [Orchestration] [Prompt templates can be consumed from registry.](orchestration/chat-completion#chat-completion-with-templates)
...
- [Orchestration] [Add new convenient methods to set the response format for Orchestration.](orchestration/chat-completion#set-a-response-format)
...
- Orchestration:
  - [Add `LlamaGuardFilter`](orchestration/chat-completion#chat-completion-filter).
  - [Convenient methods to create messages containing images and multiple text inputs](orchestration/chat-completion#add-images-and-multiple-text-inputs-to-a-message)
  - [Enable setting the response format](orchestration/chat-completion#set-a-response-format)
