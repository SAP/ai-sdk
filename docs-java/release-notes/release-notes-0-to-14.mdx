...
- [OpenAI] [Introduced SpringAI integration with our OpenAI client.](spring-ai/openai)
  - Added `OpenAiChatModel`
- [Prompt Registry] [Using Prompt Registry Templates in SpringAI.](ai-core/prompt-registry#using-templates-in-springai)
  - Added `SpringAiConverter`
- [Orchestration] [Added convenience to add custom headers to individual orchestration calls.](orchestration/chat-completion#custom-headers)
- [OpenAI] [Added convenience to add custom headers to individual LLM calls.](foundation-models/openai/chat-completion#custom-headers)
