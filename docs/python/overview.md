...
For direct model access, you need to create a deployment for each desired model according to the [help documentation for model deployments](https://help.sap.com/docs/sap-ai-core/sap-ai-core-service-guide/create-deployment-for-generative-ai-model-in-sap-ai-core).
...
The list of models in the Generative AI Hub of SAP AI Core can be found in [SAP note 3437766](https://me.sap.com/notes/3437766). Among these, the following models are currently supported in the SAP Cloud SDK for AI (Python) - generative:

### LLM Models[​](#llm-models "Direct link to LLM Models")
...
### Notes on model usage[​](#notes-on-model-usage "Direct link to Notes on model usage")
...
* **Models not added to SDK yet**:
  <!-- -->
  * You can also try using Generative AI Hub SDK for models that are already in Generative AI Hub, but not supported yet by the SDK. Please note that it's not guaranteed that it will work, as there might be new models for which customization in the SDK is needed.
