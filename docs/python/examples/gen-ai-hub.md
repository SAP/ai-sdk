...
## Completions[​](#completions "Direct link to Completions")
...
### Amazon[​](#amazon-1 "Direct link to Amazon")
...
### Structured model outputs[​](#structured-model-outputs-1 "Direct link to Structured model outputs")
...
## Embeddings[​](#embeddings-1 "Direct link to Embeddings")
