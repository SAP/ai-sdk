...
## Native LLM Clients[​](#native-llm-clients "Direct link to Native LLM Clients")

### Instance-level headers[​](#instance-level-headers "Direct link to Instance-level headers")
...
### Request-level headers[​](#request-level-headers "Direct link to Request-level headers")
...
## Orchestration Service[​](#orchestration-service "Direct link to Orchestration Service")

### Instance-level headers[​](#instance-level-headers-1 "Direct link to Instance-level headers")
...
### Request-level headers[​](#request-level-headers-1 "Direct link to Request-level headers")
...
## Prompt Registry[​](#prompt-registry "Direct link to Prompt Registry")

### Instance-level headers[​](#instance-level-headers-2 "Direct link to Instance-level headers")
...
### Request-level headers[​](#request-level-headers-2 "Direct link to Request-level headers")
...
## Document Grounding Clients[​](#document-grounding-clients "Direct link to Document Grounding Clients")

### Instance-level headers[​](#instance-level-headers-3 "Direct link to Instance-level headers")
...
### Request-level headers[​](#request-level-headers-3 "Direct link to Request-level headers")
...
## Combining Instance and Request-level Headers[​](#combining-instance-and-request-level-headers "Direct link to Combining Instance and Request-level Headers")
