...
## Prepare the Input File[​](#prepare-the-input-file "Direct link to Prepare the Input File")
...
## Step 4 — Poll for Completion[​](#step-4--poll-for-completion "Direct link to Step 4 — Poll for Completion")
...
## Retrieve Results[​](#retrieve-results "Direct link to Retrieve Results")
...
## Manage Batch Jobs[​](#manage-batch-jobs "Direct link to Manage Batch Jobs")

The Batch API also supports listing, cancelling, and deleting batch jobs. For the full management API reference, see [Batch — Managing Batch Jobs](/ai-sdk/docs/js/foundation-models/openai/batch.md#managing-batch-jobs).
...
Explore additional AI capabilities in the [SAP AI SDK documentation](/ai-sdk/docs/js/overview-cloud-sdk-for-ai-js.md).
