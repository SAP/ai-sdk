...
In this quickstart, you'll use the OpenAI GPT-4o model via the [Orchestration Service of AI Core](https://help.sap.com/docs/sap-ai-core/sap-ai-core-service-guide/orchestration) to generate text. The application will send a prompt to the AI model and display the generated response.

### Prerequisites[​](#prerequisites "Direct link to Prerequisites")

Refer to prerequisites outlined [here](/ai-sdk/docs/js/v1/overview-cloud-sdk-for-ai-js.md#prerequisites).

This quickstart assumes you are using the `default` resource group of your AI Core instance. If you need to [use a different resource group](/ai-sdk/docs/js/v1/orchestration/chat-completion.md#custom-resource-group), make sure it has an [orchestration deployment](https://help.sap.com/docs/sap-ai-core/sap-ai-core-service-guide/create-deployment-for-orchestration) available.
...
Refer to [Providing a Service Binding Locally](/ai-sdk/docs/js/v1/connecting-to-ai-core.md#providing-a-service-binding-locally) section for more information.
