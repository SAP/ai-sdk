...
Alternatively, you can use already prepared templates from the [**Prompt Registry**](/ai-sdk/docs/java/ai-core/prompt-registry.md) of SAP AI Core instead of passing a template in the request yourself.
...
You can create and store Orchestration configurations in Prompt Registry. For a guide on how to do that please refer to the chapter on [Prompt Registry](/ai-sdk/docs/java/ai-core/prompt-registry.md#orchestration-configurations-in-prompt-registry).
