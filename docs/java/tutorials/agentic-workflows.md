...
We first create two mock tools. For more information on tool usage, we refer to the respective [chapter in our documentation](/ai-sdk/docs/java/spring-ai/orchestration.md#tool-calling).
...
For more information on how to use chat memory, we refer to the respective [chapter in our documentation](/ai-sdk/docs/java/spring-ai/orchestration.md#chat-memory).
