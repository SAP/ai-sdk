...
For a quick start, check out the [getting started](/ai-sdk/docs/java/getting-started.md) section.
...
Please refer to [this documentation on **how to connect the SAP AI SDK to AI Core**](/ai-sdk/docs/java/connecting-to-ai-core.md).
