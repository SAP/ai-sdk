...
* **A Deployed Orchestration Model in SAP AI Core**
  ...
  * In case the model is deployed in a custom resource group, refer to [this section](/ai-sdk/docs/java/next/orchestration/chat-completion.md#create-a-client-and-choose-an-llm).
