...
## Simple chat completion[​](#simple-chat-completion "Direct link to Simple chat completion")
...
## Using a Custom Resource Group[​](#using-a-custom-resource-group "Direct link to Using a Custom Resource Group")
...
Or, to add multiple headers at once, use `withHeaders`.
...
var result = client.withHeaders(headers).chatCompletion("Hello World! Why is this phrase so famous?");
```
...
## Chat Completion with Specific Model Version[​](#chat-completion-with-specific-model-version "Direct link to Chat Completion with Specific Model Version")
...
## Chat completion with Custom Model[​](#chat-completion-with-custom-model "Direct link to Chat completion with Custom Model")
...
### Asynchronous Streaming - Blocking[​](#asynchronous-streaming---blocking "Direct link to Asynchronous Streaming - Blocking")
...
### Asynchronous Streaming - Non-blocking[​](#asynchronous-streaming---non-blocking "Direct link to Asynchronous Streaming - Non-blocking")
