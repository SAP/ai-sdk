...
Before using the AI Core module, ensure that you have met all the general requirements outlined in the [overview](/ai-sdk/docs/java/next/overview.md#general-requirements). Additionally, include the necessary Maven dependency in your project.
...
## Create a non-persistent response[​](#create-a-non-persistent-response "Direct link to Create a non-persistent response")
...
## Create a persistent response[​](#create-a-persistent-response "Direct link to Create a persistent response")
...
## Create a non-persistent streaming response[​](#create-a-non-persistent-streaming-response "Direct link to Create a non-persistent streaming response")
...
## Retrieve a response[​](#retrieve-a-response "Direct link to Retrieve a response")
...
## Cancel a response[​](#cancel-a-response "Direct link to Cancel a response")
...
## Useful features using endpoints mentioned above[​](#useful-features-using-endpoints-mentioned-above "Direct link to Useful features using endpoints mentioned above")

### Create a background response and poll[​](#create-a-background-response-and-poll "Direct link to Create a background response and poll")
...
### Create a multi-turn follow-up response[​](#create-a-multi-turn-follow-up-response "Direct link to Create a multi-turn follow-up response")
...
### Create a stateless multi-turn response[​](#create-a-stateless-multi-turn-response "Direct link to Create a stateless multi-turn response")
...
### Create a response with tool calling[​](#create-a-response-with-tool-calling "Direct link to Create a response with tool calling")
...
### Create a response with reasoning[​](#create-a-response-with-reasoning "Direct link to Create a response with reasoning")
...
### Create a response with structured output[​](#create-a-response-with-structured-output "Direct link to Create a response with structured output")
...
### Create a response with truncation[​](#create-a-response-with-truncation "Direct link to Create a response with truncation")
...
### Create a response with a prompt cache key[​](#create-a-response-with-a-prompt-cache-key "Direct link to Create a response with a prompt cache key")
