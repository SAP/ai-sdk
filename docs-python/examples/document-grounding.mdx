...
The Document Grounding module implements Retrieval Augmented Generation (RAG). It is a module in the [Orchestration Service](https://help.sap.com/doc/generative-ai-hub-sdk/CLOUD/en-US/_reference/orchestration-service.html). It uses the SAP HANA Vector Engine to retrieve relevant document context (the "context") and generate more accurate responses.
