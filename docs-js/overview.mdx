...
[![npm Version](https://img.shields.io/npm/v/%40sap-ai-sdk%2Fai-api?color=dark-green)](https://www.npmjs.com/search?q=%40sap-ai-sdk)
...
Please refer to [Connecting to AI Core](connecting-to-ai-core) section for **how to connect the SAP Cloud SDK for AI to AI Core**.
