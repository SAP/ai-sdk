...
In both cases, use the **two-client pattern** from the [LangGraph tutorial](../tutorials/langgraph-orchestration-client): one client with the template for the first turn, a second without it for follow-up turns.
:::
