...
For more details on structured output, refer to the [official LangChain documentation on structured output](https://js.langchain.com/docs/modules/model_io/output_parsers/structured_output).
