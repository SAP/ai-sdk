...
If you need to [use a different resource group](orchestration/chat-completion.mdx#custom-deployment-configuration), make sure it has an [orchestration deployment](https://help.sap.com/docs/sap-ai-core/sap-ai-core-service-guide/create-deployment-for-orchestration) available.
...
Refer to [Providing a Service Binding Locally](connecting-to-ai-core.mdx#providing-a-service-binding-locally) section for more information.
