...
- [Adapt all Breaking Changes](#adapt-all-breaking-changes)
  - [Package `@sap-ai-sdk/foundation-models`](#package-sap-ai-sdk-foundation-models)
  - [Package `@sap-ai-sdk/orchestration`](#package-sap-ai-sdk-orchestration)
  - [Package `@sap-ai-sdk/langchain`](#package-sap-ai-sdk-langchain)
