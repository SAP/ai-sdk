...
- [Adapt all Breaking Changes](#adapt-all-breaking-changes)
  - [Package `@sap-ai-sdk/foundation-models`](#package-sap-ai-sdkfoundation-models)
  - [Package `@sap-ai-sdk/orchestration`](#package-sap-ai-sdkorchestration)
  - [Package `@sap-ai-sdk/langchain`](#package-sap-ai-sdklangchain)
...
In the new structure, the `templating` module is renamed to `prompt`.
