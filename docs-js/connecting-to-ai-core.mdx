...
:::tip
Since SAP Cloud SDK for AI uses `@sap/xsenv` for reading the service binding, refer to [`@sap/xsenv`](https://www.npmjs.com/package/@sap/xsenv?activeTab=readme) for more information about service lookup, `VCAP_SERVICES` environment variables in Cloud Foundry, secret mounting path in Kyma / Kubernetes and many more.
:::
