...
- In Kubernetes / Kyma environments, you have to use the [BTP Service Operator](https://github.com/SAP/sap-btp-service-operator?tab=readme-ov-file#sap-business-technology-platform-sap-btp-service-operator-for-kubernetes) to create the binding.
