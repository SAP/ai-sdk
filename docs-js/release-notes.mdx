...
- [openai] Allow setting a model or deployment configuration per request. ([fea1c3f](https://github.com/SAP/ai-sdk-js/commit/fea1c3ff75a87621e800ae7bdae3d51f07dacbb7))
