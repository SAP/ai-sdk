...
See the orchestration workflow guide: https://help.sap.com/docs/sap-ai-core/sap-ai-core-service-guide/orchestration-workflow-v2.
See the embeddings endpoint documentation: https://help.sap.com/docs/sap-ai-core/sap-ai-core-service-guide/embeddings.
See [Chat Completion](./chat-completion.mdx).
...
Pass an array of strings to embed multiple inputs at once. The array returned by `getEmbeddings()` preserves the order with the `index` field.
