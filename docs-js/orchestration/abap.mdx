...
description: How to use the SAP Cloud SDK for AI to perform inference on SAP ABAP models using orchestration service from SAP AI Core.
keywords:
  - sap
  - cloud
  - sdk
...
This includes support for SAP ABAP models, allowing you to perform inference on ABAP-based AI capabilities.
...
To send an inference request, use the `chatCompletion()` method.
...
For detailed example payloads for using the `sap-abap-1` model, refer to the [SAP AI Core documentation](https://help.sap.com/docs/sap-ai-core/sap-ai-core-service-guide/sap-abap-1?q=sap+abap).
