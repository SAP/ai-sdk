...
You can define the template content by passing the contents of a YAML file as a string in the `templating` configuration.
...
This [YAML file](https://github.com/SAP/ai-sdk-js/blob/main/test-util/data/orchestration/orchestration-chat-completion-yaml-template.yaml) illustrates the format in which a prompt template can be defined for use in the templating configuration.
