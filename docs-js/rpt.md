...
Pass a [`ParquetPayload` object](/api/v2/types/rpt_src.ParquetPayload.html) containing the Parquet file, prediction configuration, and optional arguments such as `index_column` and `parse_data_types`.
