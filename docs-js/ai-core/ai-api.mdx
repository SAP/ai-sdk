...
You can pass some basic parameters for the creation of the resilience middleware.
...
const [retry, circuitBreaker, timeout] = resilience({
  ...
  retry: 3 // default false; a number indicates the number of retries
});
```

For more detailed description on how to use the resilience patterns functionality, refer to the [SAP Cloud SDK documentation on resilience](https://sap.github.io/cloud-sdk/docs/js/guides/resilience).
