...
:::note
To use [streaming](../orchestration/chat-completion.mdx#streaming) with an orchestration configuration, include streaming settings in the `spec` property when creating the configuration.
:::
...
To use a stored orchestration configuration with the `OrchestrationClient`, refer to the [Initialization with Orchestration Configuration](../orchestration/chat-completion.mdx#initialization-with-orchestration-configuration) section in the chat completion guide.
