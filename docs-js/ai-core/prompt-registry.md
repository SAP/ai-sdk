...
import type { PromptTemplateListResponse } from '@sap-ai-sdk/prompt-registry';
// ---cut---
...
The orchestration config API available as part of the prompt registry package allows to persist orchestration configurations.
