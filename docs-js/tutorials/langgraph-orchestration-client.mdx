...
const graph = new StateGraph(MessagesAnnotation)
  ...
  .addConditionalEdges(START, routeByTurn, ['firstTurnNode', 'conversationNode'])
...
For a more advanced example with tool use, human-in-the-loop interruption, and MCP integration, see the [Getting Started with Agents tutorial](./getting-started-with-agents).
...
- [Getting Started with Agents tutorial](./getting-started-with-agents)
