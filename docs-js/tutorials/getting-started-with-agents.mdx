...
```js reference referenceLinkText=" " title="Restaurant tool definition"
...
https://github.com/SAP/ai-sdk-js/blob/main/sample-code/src/tutorials/mcp/mcp-adapter.ts#L3-L23
```
...
<TabItem value="openai">
  ...
  https://github.com/SAP/ai-sdk-js/blob/main/sample-code/src/tutorials/travel-itinerary-agent.ts#L46-L58
  ```
</TabItem>
...
https://github.com/SAP/ai-sdk-js/blob/main/sample-code/src/tutorials/travel-itinerary-agent.ts#L60-L91
```

## Build the Workflow

```js reference referenceLinkText=" " title="Build the workflow"
https://github.com/SAP/ai-sdk-js/blob/main/sample-code/src/tutorials/travel-itinerary-agent.ts#L93-L103
```

:::note
Using [`MemorySaver`](https://docs.langchain.com/oss/javascript/langchain/short-term-memory#usage) allows sharing context across multiple interactions in a single conversational thread (`conv-1`).
In this example, it enables the agent to remember the previously mentioned city.
:::

<img
  src={useBaseUrl('img/Langgraph-State.png')}
  alt="LangGraph Flow"
  className="center"
/>
...
https://github.com/SAP/ai-sdk-js/blob/main/sample-code/src/tutorials/travel-itinerary-agent.ts#L105-L121
```
...
https://github.com/SAP/ai-sdk-js/blob/main/sample-code/src/tutorials/travel-itinerary-agent.ts#L123-L124
```
...
```js reference referenceLinkText=" "
https://github.com/SAP/ai-sdk-js/blob/main/sample-code/src/tutorials/travel-itinerary-agent.ts#L126-L131
```
...
```js reference referenceLinkText=" "
https://github.com/SAP/ai-sdk-js/blob/main/sample-code/src/tutorials/travel-itinerary-agent.ts#L133-L140
```
...
<Tabs>
  <TabItem value="Itinerary Planner">
    ...
    https://github.com/SAP/ai-sdk-js/blob/main/sample-code/src/tutorials/travel-itinerary-agent.ts
    ```
  </TabItem>
  <TabItem value="MCP Adapter">
    ```js reference referenceLinkText="View on GitHub"
    https://github.com/SAP/ai-sdk-js/blob/main/sample-code/src/tutorials/mcp/mcp-adapter.ts
    ```
  </TabItem>
  <TabItem value="Weather MCP Server">
    ```js reference referenceLinkText="View on GitHub"
    https://github.com/SAP/ai-sdk-js/blob/main/sample-code/src/tutorials/mcp/weather-mcp-server.ts
    ```
  </TabItem>
</Tabs>
