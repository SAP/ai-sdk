...
:::info Source code
View this example on GitHub: [https://github.com/SAP/ai-sdk-js/blob/main/sample-code/src/tutorials/travel-itinerary-agent.ts#L25-L44](https://github.com/SAP/ai-sdk-js/blob/main/sample-code/src/tutorials/travel-itinerary-agent.ts#L25-L44)
:::
...
For API usage terms, visit [Open-Meteo License](https://open-meteo.com/en/license).

:::info Source code
View this example on GitHub: [https://github.com/SAP/ai-sdk-js/blob/main/sample-code/src/tutorials/mcp/weather-mcp-server.ts#L4-L60](https://github.com/SAP/ai-sdk-js/blob/main/sample-code/src/tutorials/mcp/weather-mcp-server.ts#L4-L60)
:::
...
:::info Source code
View this example on GitHub: [https://github.com/SAP/ai-sdk-js/blob/main/sample-code/src/tutorials/mcp/mcp-adapter.ts#L3-L19](https://github.com/SAP/ai-sdk-js/blob/main/sample-code/src/tutorials/mcp/mcp-adapter.ts#L3-L19)
:::
...
:::info Source code
View this example on GitHub: [https://github.com/SAP/ai-sdk-js/blob/main/sample-code/src/tutorials/travel-itinerary-agent.ts#L65-L96](https://github.com/SAP/ai-sdk-js/blob/main/sample-code/src/tutorials/travel-itinerary-agent.ts#L65-L96)
:::

## Build the Workflow

:::info Source code
View this example on GitHub: [https://github.com/SAP/ai-sdk-js/blob/main/sample-code/src/tutorials/travel-itinerary-agent.ts#L98-L108](https://github.com/SAP/ai-sdk-js/blob/main/sample-code/src/tutorials/travel-itinerary-agent.ts#L98-L108)
:::

:::info
Using [`MemorySaver`](https://docs.langchain.com/oss/javascript/langgraph/persistence) allows sharing context across multiple interactions in a single conversational thread (`conv-1`).
In this example, it enables the agent to remember the previously mentioned city.
:::

![LangGraph Flow](/Langgraph-State.png)
...
:::info Source code
View this example on GitHub: [https://github.com/SAP/ai-sdk-js/blob/main/sample-code/src/tutorials/travel-itinerary-agent.ts#L110-L127](https://github.com/SAP/ai-sdk-js/blob/main/sample-code/src/tutorials/travel-itinerary-agent.ts#L110-L127)
:::
...
:::info Source code
View this example on GitHub: [https://github.com/SAP/ai-sdk-js/blob/main/sample-code/src/tutorials/travel-itinerary-agent.ts#L129-L130](https://github.com/SAP/ai-sdk-js/blob/main/sample-code/src/tutorials/travel-itinerary-agent.ts#L129-L130)
:::
...
:::info Source code
View this example on GitHub: [https://github.com/SAP/ai-sdk-js/blob/main/sample-code/src/tutorials/travel-itinerary-agent.ts#L132-L137](https://github.com/SAP/ai-sdk-js/blob/main/sample-code/src/tutorials/travel-itinerary-agent.ts#L132-L137)
:::
...
:::info Source code
View this example on GitHub: [https://github.com/SAP/ai-sdk-js/blob/main/sample-code/src/tutorials/travel-itinerary-agent.ts#L139-L147](https://github.com/SAP/ai-sdk-js/blob/main/sample-code/src/tutorials/travel-itinerary-agent.ts#L139-L147)
:::
...
- [Itinerary Planner](https://github.com/SAP/ai-sdk-js/blob/main/sample-code/src/tutorials/travel-itinerary-agent.ts)
- [MCP Adapter](https://github.com/SAP/ai-sdk-js/blob/main/sample-code/src/tutorials/mcp/mcp-adapter.ts)
- [Weather MCP Server](https://github.com/SAP/ai-sdk-js/blob/main/sample-code/src/tutorials/mcp/weather-mcp-server.ts)
