...
If you need to [use a different resource group](orchestration/chat-completion.mdx#custom-resource-group), make sure it has an [orchestration deployment](https://help.sap.com/docs/sap-ai-core/sap-ai-core-service-guide/create-deployment-for-orchestration) available.
