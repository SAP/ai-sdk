...
Initialize the `AzureOpenAiEmbeddingClient` by following the instructions in the [Client Initialization](../foundation-models.mdx#client-initialization) section.
...
Refer to the [Custom Request Configuration](../foundation-models.mdx#custom-request-configuration) section for more details.
